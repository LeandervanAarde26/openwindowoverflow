                ...
                if (res.status === 200) {
                    ...
                    setContent(
                        <>
                            <h3>OOPS!</h3>
                            <h5>
                                We could not verify your new account, please try again or contact support at
                                mail@openoverflow.co.za
                            </h5>
                        </>
                    )
                    setLogin(false)
    ...
    return (
        <div className={styles.container}>
            <div className={styles.left}>
                <img className='img' src={login ? theImage : brokenBrowser} alt={"ValidationImage"} />
            </div>
